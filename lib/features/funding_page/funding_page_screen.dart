...
class FundingPageScreen extends StatefulWidget {
  const FundingPageScreen({super.key});

  @override
  State<FundingPageScreen> createState() => _FundingPageScreenState();
}

class _FundingPageScreenState extends State<FundingPageScreen> {
  ...
  void initState() {
    ...
    _projectsBloc.add(GetProjectsEvent(isFundingPage: true));
    super.initState();
  }
